...
# Known issues
* This `Pre-Built Development Image` has an issue by reporting the empty serial number.
This fact rpduces a kind of problem by connecting to the device using `adb shell`.
In ordet to fix this problem follow this procedure:
